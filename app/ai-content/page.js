  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-16">
      ...
      <div className="glass rounded-2xl p-6 mb-8">
        ...
        <textarea
          id="text-input"
          className="w-full h-40 p-5 rounded-2xl resize-none focus:outline-none focus:ring-2 focus:ring-indigo-500 mb-6 text-sm shadow-inner transition-all"
          style={{
        ...
        {!hasFile ? (
          <div
            ...
            onDrop={handleDrop}
            className="w-full rounded-2xl flex items-center justify-center cursor-pointer transition-all duration-300 hover:bg-white/5 mb-6"
            style={{
        ...
        <button
          ...
          disabled={!canSubmit}
          className="w-full btn-glow rounded-2xl py-4 text-sm font-bold tracking-wide shadow-lg text-white disabled:opacity-50 disabled:cursor-not-allowed transition-all mt-4"
        >
          {loading ? (
